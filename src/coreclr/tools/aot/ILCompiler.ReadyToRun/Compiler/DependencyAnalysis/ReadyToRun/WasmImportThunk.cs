...
namespace ILCompiler.DependencyAnalysis.ReadyToRun
{
    public class WasmImportThunk : AssemblyStubNode, INodeWithTypeSignature, ISymbolDefinitionNode, ISortableSymbolNode
    {
        ...
        protected override void EmitCode(NodeFactory factory, ref Wasm.WasmEmitter instructionEncoder, bool relocsOnly)
        {
            ...
            expressions.Add(Global.Get(WasmGlobalImports.ImageBaseGlobalIndex)); // The module base address is passed as the third argument
            ...
            expressions.Add(Global.Get(WasmGlobalImports.ImageBaseGlobalIndex)); // Module base used to load the helper function address
