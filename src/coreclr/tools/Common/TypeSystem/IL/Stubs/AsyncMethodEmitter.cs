...
namespace Internal.IL.Stubs
{
    ...
    {
        public AsyncMethodEmitter(MutableModule manifestModule, CompilationModuleGroup compilationModuleGroup, CompilerTypeSystemContext typeSystemContext)
        {
        ...
        public MethodIL EmitTaskReturningStub(EcmaMethod method)
        {
            ...
            MethodDesc asyncOtherVariant = _typeSystemContext.GetAsyncVariantMethod(method);
